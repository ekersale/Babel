...
static const char qt_meta_stringdata_Subscribe[] = {
    "Subscribe\0\0toSubscribe()\0"
};
...
const QMetaObjectExtraData Subscribe::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Subscribe::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Subscribe,
      qt_meta_data_Subscribe, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Subscribe::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Subscribe))
