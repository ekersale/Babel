...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/Babel1.0.0/ && $(COPY_FILE) --parents Includes/Connection.hh Includes/Subscribe.hh Includes/Home.hh Includes/IGui.hh Includes/BabelEncoder.hh Includes/IBabelEncoder.hh Includes/Network.hh Includes/BabelSound.hh Includes/IBabelSound.hh Includes/IModule.hh Includes/INetwork.hh Includes/UClientInfo.hh Includes/OpenCV.hh .tmp/Babel1.0.0/ && $(COPY_FILE) --parents Gui/main.cpp Gui/Connection.cpp Gui/Subscribe.cpp Gui/Home.cpp Modules/Network/UClientInfo.cpp Modules/Network/UNetwork.cpp Modules/Opus/BabelEncoder.cpp Modules/PortAudio/BabelSound.cpp Modules/OpenCV/OpenCV.cpp .tmp/Babel1.0.0/ && $(COPY_FILE) --parents Gui/Ui/Connection.ui Gui/Ui/Subscribe.ui Gui/Ui/Home.ui .tmp/Babel1.0.0/ && (cd `dirname .tmp/Babel1.0.0` && $(TAR) Babel1.0.0.tar Babel1.0.0 && $(COMPRESS) Babel1.0.0.tar) && $(MOVE) `dirname .tmp/Babel1.0.0`/Babel1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Babel1.0.0
...
moc_Connection.cpp: Includes/IGui.hh \
	...
	/opt/Qt5.3.2/5.3/gcc/bin/moc $(DEFINES) -I/opt/Qt5.3.2/5.3/gcc/mkspecs/linux-g++ -I/home/napsters/Git/babel -I/home/napsters/Git/babel/Includes -I/usr/local/include/opencv2 -I/opt/Qt5.3.2/5.3/gcc/include -I/opt/Qt5.3.2/5.3/gcc/include/QtWidgets -I/opt/Qt5.3.2/5.3/gcc/include/QtXml -I/opt/Qt5.3.2/5.3/gcc/include/QtGui -I/opt/Qt5.3.2/5.3/gcc/include/QtCore Includes/Connection.hh -o moc_Connection.cpp
...
BabelEncoder.o: Modules/Opus/BabelEncoder.cpp 
