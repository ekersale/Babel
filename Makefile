...
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I. -IIncludes -I/usr/local/include/opencv2 -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtXml -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lopus -ljack -lasound -lrt -lm -lportaudio -L/usr/local/lib -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_ml -lopencv_video -lopencv_features2d -lopencv_calib3d -lopencv_objdetect -lopencv_contrib -lopencv_legacy -lopencv_flann -lopencv_nonfree -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Xml -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Babel1.0.0/ && $(COPY_FILE) --parents Includes/Connection.h Includes/Subscribe.h Includes/Home.h Includes/IGui.h Includes/BabelEncoder.h Includes/IBabelEncoder.h Includes/UNetwork.h Includes/BabelSound.h Includes/IBabelSound.h Includes/IModule.h Includes/INetwork.h Includes/UClientInfo.h Includes/OpenCV.h .tmp/Babel1.0.0/ && $(COPY_FILE) --parents Gui/main.cpp Gui/Connection.cpp Gui/Subscribe.cpp Gui/Home.cpp Modules/Network/UClientInfo.cpp Modules/Network/UNetwork.cpp Modules/Opus/BabelEncoder.cpp Modules/PortAudio/BabelSound.cpp Modules/OpenCV/OpenCV.cpp .tmp/Babel1.0.0/ && $(COPY_FILE) --parents Gui/Ui/Connection.ui Gui/Ui/Subscribe.ui Gui/Ui/Home.ui .tmp/Babel1.0.0/ && (cd `dirname .tmp/Babel1.0.0` && $(TAR) Babel1.0.0.tar Babel1.0.0 && $(COMPRESS) Babel1.0.0.tar) && $(MOVE) `dirname .tmp/Babel1.0.0`/Babel1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Babel1.0.0
...
moc_OpenCV.cpp: /usr/include/qt5/QtCore/QMutex \
		/usr/include/qt5/QtCore/qmutex.h \
		/usr/include/qt5/QtCore/qglobal.h \
		/usr/include/qt5/QtCore/qconfig.h \
		/usr/include/qt5/QtCore/qfeatures.h \
		...
		Includes/IModule.h \
		Includes/OpenCV.h
	/usr/lib/i386-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/i386-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/i686-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/i686-linux-gnu/4.8/include-fixed -I/usr/include/i386-linux-gnu -I/usr/include Includes/OpenCV.h -o moc_OpenCV.cpp
...
OpenCV.o: Modules/OpenCV/OpenCV.cpp Includes/OpenCV.h \
		/usr/include/qt5/QtCore/QMutex \
		/usr/include/qt5/QtCore/qmutex.h \
		/usr/include/qt5/QtCore/qglobal.h \
		/usr/include/qt5/QtCore/qconfig.h \
